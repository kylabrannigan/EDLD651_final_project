...
Our questions were selected based on IDK. We thought it was pertinent to IDK. 

Notably, the data we used for this analysis did not contain information about produce family. To supplement, we IDK ERIKA WHATEVER RESEARCH YOU DID. 

# Methods

For this project, the DATASET from the PLACE WE GOT IT was used to shed light on questions such as how the price of fruits and vegetables varies based on form, if fruit and vegetable prices vary by family, and how yield impacts price of produce. A full description of the dataset can be found HERE. 
