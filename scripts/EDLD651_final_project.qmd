...
price_by_form_long <- price_by_form_wide |> 
  pivot_longer(cols = c("Fresh", "Frozen", "Canned", "Dried"), 
               names_to = "Form",
               values_to = "Price") |> 
  filter(!is.na(Price))
```
