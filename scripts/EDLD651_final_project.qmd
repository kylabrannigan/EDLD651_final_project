...
The guiding questions for this study were: 1. How does the price of fruits and vegetables varies based on form? 2. Do fruit and vegetable prices vary by family? 3. What is the relationship between yield and retail price of produce?
...
Below are descriptive tables of the data. Results are presented by research question.
...
price_by_form_summary_df <- fruit_veg_df |> 
  ...
  pivot_wider(names_from = form,
              values_from = retail_price) |> 
  select(-row) |> 
  summarise(mean_fresh_price = mean(Fresh, na.rm = TRUE),
            mean_frozen_price = mean(Frozen, na.rm = TRUE),
            mean_canned_price = mean(Canned, na.rm = TRUE),
            mean_dried_price = mean(Dried, na.rm = TRUE))

price_by_form_summary_df |> 
  kable(caption = "Mean Retail Prices of Fruits and Vegetables by Form",
...
price_by_family_summary_df |> 
  kable(caption = "Mean Retail Prices of Fruits and Vegetables by Family",
